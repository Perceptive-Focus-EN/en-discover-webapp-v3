// src/email/templates/providerWelcomeEmail.ts
export const providerWelcomeEmailTemplate = {
  ...
  getHtml: (
    ...
    <body>
      <div class="container">
        ...
        <p>Welcome to AetherIQ Medical! We are thrilled to have you as a provider on our platform.</p>
        <p>As a registered provider, you now have access to our medical solutions and services.</p>
