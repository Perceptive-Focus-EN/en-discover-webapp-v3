...
export type AlternativeEducationPermission = typeof PERMISSIONS.INSTITUTE[keyof typeof PERMISSIONS.INSTITUTE];

export const L0_PERMISSIONS: AlternativeEducationPermission[] = [
...
export const L1_PERMISSIONS: AlternativeEducationPermission[] = [
...
export const L2_PERMISSIONS: AlternativeEducationPermission[] = [
...
export const L3_PERMISSIONS: AlternativeEducationPermission[] = [
...
export const L4_PERMISSIONS: AlternativeEducationPermission[] = [
...
export const ALTERNATIVE_EDUCATION_PERMISSIONS: Record<AccessLevel, AlternativeEducationPermission[]> = {
