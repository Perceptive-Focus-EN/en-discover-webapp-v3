...
export type VocationalAndAdultEducationPermission = typeof PERMISSIONS.INSTITUTE[keyof typeof PERMISSIONS.INSTITUTE];

export const L0_PERMISSIONS: VocationalAndAdultEducationPermission[] = [
...
export const L1_PERMISSIONS: VocationalAndAdultEducationPermission[] = [
...
export const L2_PERMISSIONS: VocationalAndAdultEducationPermission[] = [
...
export const L3_PERMISSIONS: VocationalAndAdultEducationPermission[] = [
...
export const L4_PERMISSIONS: VocationalAndAdultEducationPermission[] = [
...
export const VOCATIONAL_AND_ADULT_EDUCATION_PERMISSIONS: Record<AccessLevel, VocationalAndAdultEducationPermission[]> = {
