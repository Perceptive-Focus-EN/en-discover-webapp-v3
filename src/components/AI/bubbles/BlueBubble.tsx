...
interface BubbleProps {
    onClick?: (color: string) => void;  // Adjust the type to accept a string parameter
}

const BlueBubble: React.FC<BubbleProps> = ({ onClick }) => {
    return (
        <div onClick={() => onClick && onClick('blue')} style={{ cursor: 'pointer' }}>
            <svg
                width="193"
                height="212"
                viewBox="0 0 193 212"
            ...
            >
                ...
                <defs>
                    ...
                    <linearGradient id="paint0_linear_23_61782" x1="106" y1="20" x2="106" y2="184" gradientUnits="userSpaceOnUse">
                        ...
                        <stop offset="1" stop-color="#364CCF" />
                    </linearGradient>
                </defs>
            </svg>
        </div>
