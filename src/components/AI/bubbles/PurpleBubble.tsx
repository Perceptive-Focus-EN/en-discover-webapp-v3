...
const PurpleBubble: React.FC<BubbleProps> = ({ onClick }) => {
    return (
        <div onClick={() => onClick && onClick('green')} style={{ cursor: 'pointer' }}>
            ...
            >
                ...
                <defs>
                    ...
                    <linearGradient id="paint0_linear_23_61782" x1="106" y1="20" x2="106" y2="184" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#9A7DEF" />
                        <stop offset="1" stop-color="#6F44EC" />
                    </linearGradient>
                </defs>
            </svg>
        </div>
