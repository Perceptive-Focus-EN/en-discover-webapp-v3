...
const YellowBubble: React.FC<BubbleProps> = ({ onClick }) => {
    return (
        <div onClick={() => onClick && onClick('yellow')} style={{ cursor: 'pointer' }}>
            ...
            >
                ...
                <defs>
                    ...
                    <linearGradient id="paint0_linear_23_61782" x1="106" y1="20" x2="106" y2="184" gradientUnits="userSpaceOnUse">
                        ...
                        <stop offset="1" stop-color="#FFA746" />
                    </linearGradient>
                </defs>
            </svg>
        </div>
