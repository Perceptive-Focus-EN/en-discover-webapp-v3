...
// import { PostType, PostContent, TextContent, SurveyContent, VideoContent, PhotoContent, MoodContent } from './posts/api/types';
...
//     const handleReactionSelect = useCallback(async (postId: string, reactionType: EmotionId) => {
//     try {
//       await reactionOps.updateReaction(postId, reactionType);
//     } catch (error) {
...
//           <CardComponent
//             {...post}
//             onReactionSelect={(reactionType: EmotionId) => handleReactionSelect(post.id, reactionType)}
//           />
